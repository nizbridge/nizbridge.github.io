const seasonFilePaths = {
    ...
    'JJ_S1': [
        ...
        'data/jj_s1/event_623046_tier_1_results.csv'
    ],
    'Time Trial': [
        'data/ta/abudhabi_ta.csv',
        'data/ta/australia_ta.csv',
        'data/ta/austria_ta.csv',
        'data/ta/azerbaijan_ta.csv',
        'data/ta/bahrain_ta.csv',
        'data/ta/belgium_ta.csv',
        'data/ta/brazil_ta.csv',
        'data/ta/britain_ta.csv',
        'data/ta/canada_ta.csv',
        'data/ta/hungary_ta.csv',
        'data/ta/imola_ta.csv',
        'data/ta/japan_ta.csv',
        'data/ta/lasvegas_ta.csv',
        'data/ta/lusail_ta.csv',
        'data/ta/mexico_ta.csv',
        'data/ta/miami_ta.csv',
        'data/ta/monza_ta.csv',
        'data/ta/netherlands_ta.csv',
        'data/ta/saudi_ta.csv',
        'data/ta/singapore_ta.csv',
        'data/ta/spain_ta.csv',
        'data/ta/texas_ta.csv',
        'data/ta/china_ta.csv',
    ...
    'F25_career_S2': [
        ...
        'data/f25_cr_s2/event_results_5.csv',
        ...
        'data/f25_cr_s2/event_results_10.csv',
        'data/f25_cr_s2/event_results_11.csv',
        'data/f25_cr_s2/event_results_12.csv',
        'data/f25_cr_s2/event_results_13.csv',
        'data/f25_cr_s2/event_results_14.csv',
        'data/f25_cr_s2/event_results_15.csv',
        'data/f25_cr_s2/event_results_16.csv',
        'data/f25_cr_s2/event_results_17.csv',
    ],
    'JJ_S2': [
        'data/jj_s2/event_results_1.csv',
        'data/jj_s2/event_results_2.csv',
    ],
};
